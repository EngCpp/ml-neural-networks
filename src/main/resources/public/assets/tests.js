...
define('ui/tests/integration/components/film-selected-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | film-selected', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "c5s4uuNR",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"film-selected\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "aaaRHvR+",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"film-selected\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('ui/tests/integration/components/video-card-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | video-card', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "UDTazeSQ",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"video-card\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "gbeujQKN",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"video-card\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('ui/tests/integration/components/video-list-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | video-list', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "Px9z9bEc",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"video-list\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "1seDVIiZ",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"video-list\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('ui/tests/lint/app.lint-test', [], function () {
  ...
  QUnit.test('adapters/film.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'adapters/film.js should pass ESLint\n\n');
  });

  QUnit.test('adapters/recommendation.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'adapters/recommendation.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('components/film-selected.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/film-selected.js should pass ESLint\n\n');
  });

  QUnit.test('components/video-card.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/video-card.js should pass ESLint\n\n18:7 - \'$\' is not defined. (no-undef)\n19:9 - Don\'t use jQuery without Ember Run Loop (ember/jquery-ember-run)');
  });

  QUnit.test('components/video-list.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/video-list.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('models/film.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'models/film.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('routes/film.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/film.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('serializers/film.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'serializers/film.js should pass ESLint\n\n');
  });

  QUnit.test('serializers/recommendation.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'serializers/recommendation.js should pass ESLint\n\n');
  });
...
define('ui/tests/lint/templates.template.lint-test', [], function () {
  ...
  QUnit.test('ui/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ui/templates/application.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('ui/templates/components/film-selected.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ui/templates/components/film-selected.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('ui/templates/components/video-card.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ui/templates/components/video-card.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('ui/templates/components/video-list.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ui/templates/components/video-list.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('ui/templates/film.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ui/templates/film.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('ui/templates/home.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ui/templates/home.hbs should pass TemplateLint.\n\n');
  });
});
define('ui/tests/lint/tests.lint-test', [], function () {
  ...
  QUnit.test('integration/components/film-selected-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/film-selected-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/video-card-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/video-card-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/video-list-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/video-list-test.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('unit/routes/film-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/film-test.js should pass ESLint\n\n');
  });
...
define('ui/tests/unit/routes/film-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | film', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    (0, _qunit.test)('it exists', function (assert) {
      let route = this.owner.lookup('route:film');
      assert.ok(route);
    });
  });
});
define('ui/tests/unit/routes/home-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('ui/tests/unit/services/config-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
